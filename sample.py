...
DOTASpilter.image_split(img_dst_path="TestDataSet/DOTA/train/devided_images", size_w=412, size_h=412, step=412)
DOTASpilter.txt_split(img_floder="TestDataSet/DOTA/train/images", out_img_floder="TestDataSet/DOTA/train/devided_images", txt_floder="TestDataSet/DOTA/train/VOC", out_txt_floder="TestDataSet/DOTA/train/devided_labels", size_w=412, size_h=412)
